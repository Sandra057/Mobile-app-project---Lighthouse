...
import 'businessmodel_model.dart';
export 'businessmodel_model.dart';

class BusinessmodelWidget extends StatefulWidget {
  const BusinessmodelWidget({super.key});

  @override
  State<BusinessmodelWidget> createState() => _BusinessmodelWidgetState();
}

class _BusinessmodelWidgetState extends State<BusinessmodelWidget> {
  late BusinessmodelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessmodelModel());
