...
import 'compatibility_model.dart';
export 'compatibility_model.dart';

class CompatibilityWidget extends StatefulWidget {
  const CompatibilityWidget({super.key});
...
class _CompatibilityWidgetState extends State<CompatibilityWidget> {
  late CompatibilityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompatibilityModel());
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      card58TransferLargeUsers1Record?.cSector,
                                      'bh',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      card58TransferLargeUsers1Record?.cStage,
                                      'mhbn',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      card58TransferLargeUsers1Record?.cSize,
                                      'nvb',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
