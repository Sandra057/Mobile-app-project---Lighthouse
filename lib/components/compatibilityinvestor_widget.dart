...
import 'compatibilityinvestor_model.dart';
export 'compatibilityinvestor_model.dart';

class CompatibilityinvestorWidget extends StatefulWidget {
  const CompatibilityinvestorWidget({super.key});

  @override
  State<CompatibilityinvestorWidget> createState() =>
      _CompatibilityinvestorWidgetState();
}

class _CompatibilityinvestorWidgetState
    extends State<CompatibilityinvestorWidget> {
  late CompatibilityinvestorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompatibilityinvestorModel());
