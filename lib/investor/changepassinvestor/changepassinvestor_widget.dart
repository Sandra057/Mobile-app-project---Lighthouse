...
import 'changepassinvestor_model.dart';
export 'changepassinvestor_model.dart';

class ChangepassinvestorWidget extends StatefulWidget {
  const ChangepassinvestorWidget({super.key});

  @override
  State<ChangepassinvestorWidget> createState() =>
      _ChangepassinvestorWidgetState();
}

class _ChangepassinvestorWidgetState extends State<ChangepassinvestorWidget> {
  late ChangepassinvestorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangepassinvestorModel());
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if ((_model.uPasswordTextController1.text != '') &&
                            ...
                            await columnInvestorsRecord!.reference
                                .update(createInvestorsRecordData(
                              iPassword: columnInvestorsRecord.iPassword,
                              iCpassword: columnInvestorsRecord.iCpassword,
                            ));
                          } else {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('Empty Details'),
                                  content: const Text(
                                      'Fill both the field to update password'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
