...
import 'invprof_user_pov_model.dart';
export 'invprof_user_pov_model.dart';

class InvprofUserPovWidget extends StatefulWidget {
  const InvprofUserPovWidget({
    super.key,
  ...
  @override
  State<InvprofUserPovWidget> createState() => _InvprofUserPovWidgetState();
}

class _InvprofUserPovWidgetState extends State<InvprofUserPovWidget>
    with TickerProviderStateMixin {
  late InvprofUserPovModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvprofUserPovModel());
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<List<Users1Record>>(
          ...
          builder: (context, snapshot) {
            ...
            List<Users1Record> stackUsers1RecordList = snapshot.data!;
            final stackUsers1Record = stackUsers1RecordList.isNotEmpty
                ? stackUsers1RecordList.first
                : null;
            return Stack(
              children: [
                Align(
                  ...
                  child: StreamBuilder<List<InvestorsRecord>>(
                    stream: queryInvestorsRecord(
                      queryBuilder: (investorsRecord) => investorsRecord.where(
                        'i_email',
                        isEqualTo: widget.investorEmail,
                      ),
                      singleRecord: true,
                    ),
                    builder: (context, snapshot) {
                      ...
                      List<InvestorsRecord> containerInvestorsRecordList =
                          snapshot.data!;
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                containerInvestorsRecord.iDisplayName,
                                                                                '0',
                                                                              ),
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  containerInvestorsRecord.occupation,
                                                                                  'df',
                                                                                ),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            await RequestInvRecord.collection.doc().set({
                                                                              ...createRequestInvRecordData(
                                                                                senderMail: currentUserEmail,
                                                                                senderName: stackUsers1Record?.uDisplayName,
                                                                                recieverMail: widget.investorEmail,
                                                                                notificationMessage: 'Company would like to connect with you',
                                                                            ...
                                                                            await MyRequestsCompanyRecord.collection.doc().set({
                                                                              ...createMyRequestsCompanyRecordData(
                                                                                cMail: currentUserEmail,
                                                                                iMail: widget.investorEmail,
                                                                                iPic: containerInvestorsRecord.iPic,
                                                                                iName: containerInvestorsRecord.iDisplayName,
                                                                              ),
                                                                              ...mapToFirestore(
                                                                                {
                                                                                  'time': FieldValue.serverTimestamp(),
                                                                                                                        ...
                                                                                                                        children: [
                                                                                                                          ...
                                                                                                                          Row(
                                                                                                                            ...
                                                                                                                            children: [
                                                                                                                              Text(
                                                                                                                                valueOrDefault<String>(
                                                                                                                                  listViewPostInvestorRecord.timePosted?.toString(),
                                                                                                                                  '0',
                                                                                                                                ),
                                                                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                                      fontFamily: 'Manrope',
