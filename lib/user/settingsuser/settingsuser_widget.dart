...
import 'settingsuser_model.dart';
export 'settingsuser_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Users1Record>>(
      ...
      builder: (context, snapshot) {
        ...
        List<Users1Record> settingsuserUsers1RecordList = snapshot.data!;
        final settingsuserUsers1Record = settingsuserUsers1RecordList.isNotEmpty
            ? settingsuserUsers1RecordList.first
            : null;
                  ...
                  children: [
                                              ...
                                              child:
                                                ...
                                                image: CachedNetworkImage(
                                                  ...
                                                  fadeOutDuration: const Duration(
                                                      milliseconds: 500),
                                                  imageUrl:
                                                      settingsuserUsers1Record
                                                          .uProfilePic,
                                                  fit: BoxFit.contain,
                                                ),
                                                allowRotation: false,
                                                tag: settingsuserUsers1Record
                                                    .uProfilePic,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('edit_company_details');
                        },
                        child: Container(
                          width: double.infinity,
                          height: 60.0,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('changepassuser');
                        },
                        child: Container(
                          width: double.infinity,
                          height: 60.0,
